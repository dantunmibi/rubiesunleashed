...
export default function HelpPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We link to external sites (Itch.io, Drive). If a link stops working, please click 'Report Issue' on the game page or contact us so we can fix it."
    },
    // --- ACCOUNT ---
    {
      category: "Account",
      question: "Do I need to sign up?",
      answer: "No. You are currently using a 'Guest Session'. Your Wishlist is saved to this device automatically. You don't need an email to use the site."
    },
    {
      category: "Account",
      question: "When can I save my data to the cloud?",
      answer: "Real accounts are coming soon in the next update. This will allow you to save your Wishlist and sync it across your phone and computer."
    },
    // --- DEVELOPERS (UPDATED) ---
    {
      category: "Developers",
    ...
    },
    {
      ...
      answer: "Please re-submit the Google Form with the new links and version number, OR use the Contact page to message us directly with your Game Name and the update details."
    },
    {
      category: "Developers",
      question: "My game is listed. How do I claim it?",
      answer: "The 'Claim Protocol' is coming soon (Phase 3). Once active, you will be able to click 'Claim Project' on the game page to request an Architect Account. All claims will be manually verified by our team."
    },
    {
      category: "Developers",
      question: "Do I need a Developer Account?",
      answer: "Not yet. Architect Accounts are currently in development. For now, you can submit and manage your content simply by using the forms and contact channels."
    },
    // --- SAFETY ---
    {
      category: "Safety",
      question: "Are files safe to download?",
      answer: "We manually review submissions and prefer links from trusted sources like Itch.io or Steam. However, as an indie marketplace, we always recommend using an antivirus on your device."
    },
    // --- FEATURES ---
    {
      category: "Features",
      question: "How do I install this site as an App?",
      answer: "Mobile: Tap 'Share' (iOS) or 'Menu' (Android) -> 'Add to Home Screen'. Desktop: Look for the install icon in your browser's address bar."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 relative">
            <h1 className="text-4xl md:text-7xl font-black mb-6 tracking-tighter text-white uppercase drop-shadow-2xl">
              Help <span className="text-transparent bg-clip-text bg-linear-to-b from-ruby to-ruby-800">Center</span>
            </h1>
          ...
          <div ref={faqSectionRef} className="max-w-4xl mx-auto mb-24 scroll-mt-32">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="text-2xl font-black text-white uppercase tracking-widest flex items-center gap-3">
                ...
                {searchQuery ? `Search Results: "${searchQuery}"` : (activeFilter === "All" ? "Common Questions" : activeFilter)}
              </h2>
              <div className="h-px bg-white/10 flex-1" />
            </div>
                  ...
                  <div key={i} className="group bg-surface/20 border border-white/5 rounded-2xl overflow-hidden transition-all hover:border-white/20 hover:bg-surface/40">
                    ...
                    <div 
                      className={`px-8 overflow-hidden transition-all duration-300 ease-in-out ${
                        openFaq === i ? "max-h-96 opacity-100 pb-8" : "max-h-0 opacity-0"
                      }`}
                    >
            ...
            <div className="relative z-10 p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 text-center md:text-left">
              <div>
                ...
                <p className="text-slate-400 max-w-md text-lg font-medium">
                  If you couldn't find the solution above, our team is ready to assist.
                </p>
              </div>
