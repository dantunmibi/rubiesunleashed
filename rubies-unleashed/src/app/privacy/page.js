...
import { Lock, Eye, Database, UserCheck, Shield, Cookie, Mail } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed font-medium">
              Your treasure is safe with us! Here's how we protect your data on this legendary quest. 🛡️✨
            </p>
          ...
          <div className="bg-surface/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 mb-12">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-black text-white mb-2">Privacy at a Glance</h2>
                <p className="text-slate-400 font-medium">Our commitment to your privacy:</p>
              </div>
            </div>
            <ul className="space-y-3 text-slate-300 font-medium">
              <li className="flex items-start gap-3">
                <span className="text-ruby text-xl">🔒</span>
                <span>We collect only what's necessary to run an awesome platform</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-ruby text-xl">🛡️</span>
                <span>Your data is encrypted and protected with industry-standard security</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-ruby text-xl">✋</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-ruby text-xl">👑</span>
                <span>You control your data - access, update, or delete it anytime</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <div className="bg-surface/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
              <h3 className="text-xl font-black text-white mb-4">Children's Privacy</h3>
              <p className="text-slate-300 font-medium leading-relaxed">
                Rubies Unleashed is designed for users aged 13 and older. We do not knowingly collect personal information from children under 13. If you believe a child has provided us with personal information, please contact us immediately.
              </p>
            </div>

            <div className="bg-surface/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
              <h3 className="text-xl font-black text-white mb-4">International Users</h3>
              <p className="text-slate-300 font-medium leading-relaxed">
                Rubies Unleashed operates globally. By using our service, you consent to the transfer of your information to countries where we operate, which may have different data protection laws than your country.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-surface/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
            <h2 className="text-2xl font-black text-white mb-4">Privacy Questions?</h2>
            <p className="text-slate-300 font-medium mb-6">
              Have concerns about your privacy or data? Want to exercise your rights? We're here to help! Reach out to our privacy team.
            </p>
