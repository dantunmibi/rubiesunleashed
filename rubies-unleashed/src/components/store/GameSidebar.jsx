...
export default function GameSidebar({ game }) {
  ...
  const handleSocialClick = (e, url) => {
    ...
    try {
      ...
      const isTrusted = trustedSocialDomains.some(
  ...
  return (
    <>
        ...
        <div className="bg-[#161b2c] p-6 rounded-2xl border border-white/5 sticky top-24 shadow-xl shadow-black/20">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 grid grid-cols-2 gap-3">
            ...
            >
              ...
              />
              <span className="text-[10px] font-bold text-slate-500 group-hover:text-red-400 uppercase tracking-widest">
                Report
              </span>
            </button>
            ...
            {isBloggerProject ? (
              ...
              >
                ...
                />
                <span className="text-[10px] font-bold text-slate-500 group-hover:text-emerald-400 uppercase tracking-widest">
                  Claim
                </span>
              </Link>
            ) : (
      ...
      {/* Report modal */}
      {showReport && (
        <ReportModal game={game} onClose={() => setShowReport(false)} />
      )}
    </>
  );
}
