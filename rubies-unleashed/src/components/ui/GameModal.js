...
import { getGameTheme } from "@/lib/theme-utils"; // ✅ Modular Import
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className={`p-3 bg-background border border-white/5 rounded-sm ${theme.borderHover} transition-colors`}>
                  ...
                  <div className="flex items-center justify-between text-white font-bold text-[10px] uppercase tracking-wider">
                      ...
                      {/* ✅ FIX: Moved shrink-0 into className */}
                ...
                <div className={`p-3 bg-background border border-white/5 rounded-sm ${theme.borderHover} transition-colors`}>
                  ...
                  <div className="flex items-center justify-between text-white font-bold text-[10px] uppercase tracking-wider">
                      ...
                      {/* ✅ FIX: Applied here too if needed, though GitBranch usually doesn't need shrink if text is short */}
            ...
            <div className="flex gap-3">
              ...
              {hasMultipleBuilds ? (
                <div className="flex-4 flex gap-2 overflow-x-auto no-scrollbar">
                    {downloadLinks.map((link, i) => (
                        <a 
                            ...
                            className={`flex-1 bg-background border border-white/10 ${theme.borderHover} hover:bg-white/5 text-white font-bold uppercase tracking-wider py-3 px-3 flex items-center justify-center gap-2 transition-all text-[9px] whitespace-nowrap rounded-sm`}
                        >
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer" 
                  className={`flex-4 bg-background border border-white/10 ${theme.borderHover} hover:bg-white/5 text-white font-black uppercase tracking-widest py-3 flex items-center justify-center gap-2 transition-all text-[10px] rounded-sm`}
                >
              ...
              {/* Wishlist Button - Stays Neutral/Ruby unless active */}
              <button 
