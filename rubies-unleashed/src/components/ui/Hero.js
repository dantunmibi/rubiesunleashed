      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8 relative z-10 text-center lg:text-left order-2 lg:order-1">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start animate-in slide-in-from-bottom-4 fade-in duration-700 delay-300">
            <Link
              href="/explore"
              className="group relative bg-ruby hover:bg-ruby-light text-white px-8 py-4 rounded-xl font-black uppercase tracking-wider transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(224,17,95,0.4)] shadow-[0_4px_0_var(--color-ruby-dark)] active:shadow-none active:translate-y-1 flex items-center justify-center gap-2"
            >
              Explore Vault{" "}
              <ArrowRight
                size={20}
            ...
            <Link
              href="/publish"
              target="_blank"
              className="bg-white/5 backdrop-blur-md border border-white/10 text-white px-8 py-4 rounded-xl font-bold uppercase tracking-wider hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
              Start Publishing
            </Link>
          </div>
